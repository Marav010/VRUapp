    ...
    return (
        ...
        <View>
            <View style={{ padding: 10, marginHorizontal: 20, backgroundColor: 'white', alignItems: 'center', borderColor: 'gray' }}>
                ...
                {/* ก้อนที่ 3 */}
                <View style={{ padding: 10, flexDirection: 'column', marginBottom: 10, borderWidth: 1, borderColor: "gray", borderRadius: 5 }}>
                    <View style={{}}>
            ...
            <View style={{ padding: 10, marginHorizontal: 20, backgroundColor: 'white', borderColor: 'gray' }}>
                {/* ก้อนที่ 1 */}
                <View style={{ marginBottom: 10 }}>
                    <Text style={{ fontSize: 15, color: 'gray' }}>Reciepient Information</Text>
                </View>
